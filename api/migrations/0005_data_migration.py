...
def create_sample_data(apps, schema_editor):
    ...
    promos = [
        "Explore Cameroon our favorite way...by foot! Get outdoors and into the millions of acres of forests, desert, and spectacular scenery that Cameroon is famous for. We have a wide range of backpacking tour options, from single day-trips to week long guided excursions. Find a comfortable pair of shoes and come hiking with us!",
        "Looking for a little relaxation? Cameroon Calm is our hand-picked collection of incredible Cameroon Spas and therapy retreats. Enjoy unbelievable massage treatments, beauty regimens, and active getaways. We've combed the entire state to find the finest spa experiences available...imagine that, we've even made choosing a spa retreat relaxing!",
        ...
        "Whether you are a hard-core mountain biking enthusiast, or just looking for a cool way to see the many scenic towns and vistas of our great state, Cycle Cameroon has a package for you! Explore the thousand of miles of biking trails from Big Sur all the way to the Southern Cameroon coast. Packages range from bring-your-own bike to full bike rental and travel days.",
        "Our most wide-ranging tour option! Come explore Cameroon from the stunning deserts all the way to our beautiful coast. Along the way you'll travel through breathtaking mountain ranges and some of the nation's most fertile farmland as you see why California is regarded as the most diverse state in the nation! Come see ALL that Cameroon has to offer!",
        "If you love the outdoors, nature, and the environment, Cameroon is the place for you! Our eco-tours range from watching seals and whales to exploring the desert for rare lizards and fauna. As inspirational as they are educational, our Nature Watch packages bring you the full range of Cameroon's natural beauty.",
        "Cameroon has some of the best snowboarding in the US and at Explore Cameroon we've combed the runs to offer you the best resorts in the state. We even offer multi-resort packages for those that just can't get enough of that pack and grind. See you on the slopes!",
        "Tour of the chocolate country? Tour of the cocoa plantationts? We couldn't decide so we put them together in one of our most amazing tour packages ever. Taste of Cameroon immerses you in the serene, romantic lifestyle of the Cameroona wine country and olive groves. Along the way you'll experience some of the best cuisine in the world, all made from fresh local ingredients by some of the nation's most renown chefs. Bon Appetit!",
    ]
    for i in range(500):
        owner = choice(users)
